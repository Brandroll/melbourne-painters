    ...
    <>
      ...
      <div className="max-w-site-full mx-auto">
        ...
        <section className="grid grid-cols-2 my-8 md:my-0 lg:my-8 px-4 lg:px-8 md:grid-cols-8 gap-1">
          <div className="col-span-6  md:col-span-8 lg:col-span-6 order:2   bg-form">
            <div className="col-span-2 lg:hidden order-1 p-2 px-4">
              ...
              <div className=" flex font-isidorasans_medium flex-col gap-3 text-sm ">
                ...
                <h3 className="text-2xl my-2  text-brand-blue">Free Quotes</h3>
              </div>
            </div>
            <form className="grid grid-cols-1 gap-4 lg:grid-cols-2 p-4 lg:gap-8 font-normal">
              <div className="grid col-span-2 md:col-span-1  ">
                <label className="text-center text-brand-blue mb-3 ">
                  First Name
                </label>
                <input
          ...
          <div className="col-span-2 hidden lg:block order-1 px-2">
            <div>
              <h3 className="text-2xl font-semibold text-brand-blue">
                Get A Free Quote
              </h3>
              <p className="my-4  text-gray-700 font-thin">
                Want to discuss a project over the phone or book your free
                on-site inspection give us a call and one of our friendly staff
