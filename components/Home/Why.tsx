          ...
          <>
            <div className="my-8  px-10 lg:px-0">
              ...
              <p className="lg:px-16 font-isidorasans_regular text-gray-900 text-center font-light">
                ...
                and discuss your painting requirements. Our painting experts can
                assist with all aspects of you painting requirements. Book a
                time today for a free measure and quote consultation.
              </p>
            </div>
