...
export default function ButtonGroup() {
  ...
  return (
    <div className="grid grid-cols-2 justify-center font-semibold">
      <div className="flex font-isidorasans_regular justify-end">
        <button
          onClick={() => onFreeQuote()}
      ...
      <div className="flex justify-start">
        <button
          ...
          className="p-3 w-full md:w-auto lg:p-2 font-semibold lg:text-xl  md:px-20 rounded-r-full lg:px-12 hover:bg-brand-blue   md:text-md md:rounded-r-3xl text-xs sm:text-sm bg-brand-blue-dark  lg:text-2xl text-white"
        >
          <Link href={"/project"}>
